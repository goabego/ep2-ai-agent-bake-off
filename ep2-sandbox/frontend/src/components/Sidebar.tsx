...
import { fetchInvestments, fetchDebts } from '@/services/api';
  ...
  useEffect(() => {
    if (userId) {
      const loadData = async () => {
        try {
          const [investmentsData, debtsData] = await Promise.all([
  ...
  return (
    <div className="flex flex-col w-80">
      ...
      {investments.slice(0, 5).map((account) => (
        <div key={account.account_id} className="flex items-center gap-4 bg-background px-4 min-h-[72px] py-2 justify-between mb-2 rounded-lg">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-foreground text-base font-medium leading-normal line-clamp-1">{account.description}</p>
      ...
      {investments.length > 5 && (
        <button className="text-primary hover:underline mt-2">View More</button>
      )}
      ...
      <div className="flex flex-col gap-2">
        {/* Transfer */}
        <div className="flex items-center gap-4 bg-background px-4 min-h-14 justify-between rounded-lg">
          <div className="flex items-center gap-4">
            ...
            <p className="text-foreground text-base font-normal leading-normal flex-1 truncate">Transfer</p>
          </div>
        ...
        <div className="flex items-center gap-4 bg-background px-4 min-h-14 justify-between rounded-lg">
          <div className="flex items-center gap-4">
            ...
            <p className="text-foreground text-base font-normal leading-normal flex-1 truncate">Pay Bills</p>
          </div>
          <div className="shrink-0">
            <div className="text-muted-foreground flex size-7 items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256"><path d="M181.66,133.66l-80,80a8,8,0,0,1-11.32-11.32L164.69,128,90.34,53.66a8,8,0,0,1,11.32-11.32l80,80A8,8,0,0,1,181.66,133.66Z"></path></svg>
        ...
        <div className="flex items-center gap-4 bg-background px-4 min-h-14 justify-between rounded-lg">
          <div className="flex items-center gap-4">
            ...
            <p className="text-foreground text-base font-normal leading-normal flex-1 truncate">Deposit</p>
          </div>
          <div className="shrink-0">
            <div className="text-muted-foreground flex size-7 items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256"><path d="M181.66,133.66l-80,80a8,8,0,0,1-11.32-11.32L164.69,128,90.34,53.66a8,8,0,0,1,11.32-11.32l80,80A8,8,0,0,1,181.66,133.66Z"></path></svg>
