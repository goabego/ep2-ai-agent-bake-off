...
class GeminiAgent(LlmAgent):
    ...
    name: str = "cymbal_bank_agent"
    description: str = "The Cymbal Bank Agent is a helpful assistant that can answer questions about the user's bank accounts, transactions, and financial goals."
        ...
        return AgentCard(
            ...
            skills=[
                AgentSkill(
                    id="chat",
                    name="Chat Skill",
                    description="A simple chat skill that can answer questions about the user's bank accounts, transactions, and financial goals.",
                    tags=["chat","financial"],
                    examples=[
